...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:anD1llJukmWo1qq9aJegYQ
# These lines were loaded from '/usr/local/share/perl/5.10.1/SIMS/Schema/Result/Meeting.pm' found in @INC.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CzG9lGJ8hcwWJEWyWNtd9Q
# These lines were loaded from '/home/kthakore/.perl5/perls/perl-5.12.2/lib/site_perl/5.12.2/SIMS/Schema/Result/Meeting.pm' found in @INC.
# They are now part of the custom portion of this file
# for you to hand-edit.  If you do not either delete
# this section or remove that file from @INC, this section
# will be repeated redundantly when you re-create this
...
1;
# End of lines loaded from '/home/kthakore/.perl5/perls/perl-5.12.2/lib/site_perl/5.12.2/SIMS/Schema/Result/Meeting.pm' 


# You can replace this text with custom content, and it will be preserved on regeneration
__PACKAGE__->meta->make_immutable;
1;
# End of lines loaded from '/usr/local/share/perl/5.10.1/SIMS/Schema/Result/Meeting.pm' 
