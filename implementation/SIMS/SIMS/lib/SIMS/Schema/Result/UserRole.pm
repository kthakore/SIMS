...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LsNQi6TaDyx99e+KY6qSKQ
# These lines were loaded from '/usr/local/share/perl/5.10.1/SIMS/Schema/Result/UserRole.pm' found in @INC.
...
__PACKAGE__->meta->make_immutable;
1;
# End of lines loaded from '/usr/local/share/perl/5.10.1/SIMS/Schema/Result/UserRole.pm' 
