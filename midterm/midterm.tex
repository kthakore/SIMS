...
The SIMS system is a web application that will be used to track the funding and progress of graduate students through the Masters program in the Medical BioPhyics department at University of Western Ontario. The system will also work to provide reminders and gather reponses from graduate students in the program. 
\section{Specific requirements}
\subsection{External interface requirements}
\subsubsection{Hardware interfaces}
\begin{description}
\item[Electronic Signature Pad]\hfill \\
A hardware interface will be required to record signatures from several roles for electronic records of forms. The data from the signature pad must be encrypted as it is read, and saved in an appropriate protocol on the DB. 
\end{description}
