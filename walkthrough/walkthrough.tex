...
\end{itemize}
\begin{figure}[!h]
\includegraphics[width180px]{diagrams/use_cases/UserHeirachy_uc} \caption{ Roles of the SIMS system } \label{fig:Users}
\end{figure}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item
Seperate Authentication Data from System Data
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Client E-Signature Capture
\item OpenVPN
